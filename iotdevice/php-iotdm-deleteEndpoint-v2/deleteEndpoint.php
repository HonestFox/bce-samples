...
$ak = "";  // AccessKeyId
$sk = "";  // SecretAccessKey
$endpointName = "";  // 要删除的 iothub 实例的名称

$method = "DELETE";
$host = "iotdm.gz.baidubce.com";
$uri = "/v2/iot/management/endpoint/{$endpointName}";
$params = array("cleanHub" => true);  // cleanHub 的值只能是 true
...
$url = "http://{$host}{$uri}?cleanHub={$params["cleanHub"]}";
